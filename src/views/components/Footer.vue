    ...
    <div class="container-3 w-container">
      <div class="w-row">
        ...
        <div class="column-6 w-col w-col-4 w-col-small-4">
          ...
          <a href="https://lavatoken.com/" target="_blank" class="footer-link">Lava Token</a>
        ...
        <div class="column-7 w-col w-col-4 w-col-small-4">
          ...
          <a href="https://meoau.itch.io/zero-chan-learns-crypto" target="_blank" class="footer-link">Play Trav&#x27;s 0xBTC Game</a></div>
      </div>
    </div>
  </div>
</template>
